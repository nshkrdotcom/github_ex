defmodule GitHubSDK.Codegen.Renderer do
  @moduledoc """
  Renderer overrides that emit `GitHubSDK.<Resource>.<verb>(client, params)` functions.
  """
  ...
  def render_operation_spec(state, operation) do
    ...
    client = quote(do: client :: GitHubSDK.Client.t())
  ...
  def render_operation_function(state, operation) do
    ...
    auth =
      if oauth_application? do
        quote(do: GitHubSDK.Client.oauth_application_request_auth(params))
      else
    ...
    partition_params =
      if oauth_application? do
        quote(do: GitHubSDK.Client.drop_oauth_application_credentials(params))
      else
        quote(do: GitHubSDK.Client.drop_request_controls(params))
      end
