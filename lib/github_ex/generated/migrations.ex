defmodule GitHubEx.Migrations do
  ...
  * `migrations/list-repos-for-authenticated-user`
  ...
  @spec cancel_import(GitHubEx.Client.t()) :: result
  @spec cancel_import(GitHubEx.Client.t(), map()) :: result
  def cancel_import(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :cancel_import},
  ...
  @spec delete_archive_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec delete_archive_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def delete_archive_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :delete_archive_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_archive_for_org(GitHubEx.Client.t()) :: result
  @spec delete_archive_for_org(GitHubEx.Client.t(), map()) :: result
  def delete_archive_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :delete_archive_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec download_archive_for_org(GitHubEx.Client.t()) :: result
  @spec download_archive_for_org(GitHubEx.Client.t(), map()) :: result
  def download_archive_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :download_archive_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_archive_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec get_archive_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def get_archive_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_archive_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_commit_authors(GitHubEx.Client.t()) :: result
  @spec get_commit_authors(GitHubEx.Client.t(), map()) :: result
  def get_commit_authors(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_commit_authors},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_import_status(GitHubEx.Client.t()) :: result
  @spec get_import_status(GitHubEx.Client.t(), map()) :: result
  def get_import_status(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_import_status},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_large_files(GitHubEx.Client.t()) :: result
  @spec get_large_files(GitHubEx.Client.t(), map()) :: result
  def get_large_files(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_large_files},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_status_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec get_status_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def get_status_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_status_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_status_for_org(GitHubEx.Client.t()) :: result
  @spec get_status_for_org(GitHubEx.Client.t(), map()) :: result
  def get_status_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :get_status_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :list_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :list_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_repos_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec list_repos_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def list_repos_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :list_repos_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_repos_for_org(GitHubEx.Client.t()) :: result
  @spec list_repos_for_org(GitHubEx.Client.t(), map()) :: result
  def list_repos_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :list_repos_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec map_commit_author(GitHubEx.Client.t()) :: result
  @spec map_commit_author(GitHubEx.Client.t(), map()) :: result
  def map_commit_author(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :map_commit_author},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec set_lfs_preference(GitHubEx.Client.t()) :: result
  @spec set_lfs_preference(GitHubEx.Client.t(), map()) :: result
  def set_lfs_preference(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :set_lfs_preference},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  def start_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :start_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec start_for_org(GitHubEx.Client.t()) :: result
  @spec start_for_org(GitHubEx.Client.t(), map()) :: result
  def start_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :start_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @doc "Start an import\n\nPath: /repos/{owner}/{repo}/import\n\nMethod: put"
  @spec start_import(GitHubEx.Client.t()) :: result
  @spec start_import(GitHubEx.Client.t(), map()) :: result
  def start_import(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :start_import},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec unlock_repo_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec unlock_repo_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def unlock_repo_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :unlock_repo_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec unlock_repo_for_org(GitHubEx.Client.t()) :: result
  @spec unlock_repo_for_org(GitHubEx.Client.t(), map()) :: result
  def unlock_repo_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Migrations, :unlock_repo_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec update_import(GitHubEx.Client.t()) :: result
  @spec update_import(GitHubEx.Client.t(), map()) :: result
  def update_import(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Migrations, :update_import},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
