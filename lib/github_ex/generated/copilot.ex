defmodule GitHubEx.Copilot do
  ...
  * `copilot/copilot-metrics-for-team`
  ...
  @spec add_copilot_seats_for_teams(GitHubEx.Client.t()) :: result
  @spec add_copilot_seats_for_teams(GitHubEx.Client.t(), map()) :: result
  def add_copilot_seats_for_teams(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Copilot, :add_copilot_seats_for_teams},
  ...
  @spec add_copilot_seats_for_users(GitHubEx.Client.t()) :: result
  @spec add_copilot_seats_for_users(GitHubEx.Client.t(), map()) :: result
  def add_copilot_seats_for_users(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Copilot, :add_copilot_seats_for_users},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec cancel_copilot_seat_assignment_for_teams(GitHubEx.Client.t()) :: result
  @spec cancel_copilot_seat_assignment_for_teams(GitHubEx.Client.t(), map()) :: result
  def cancel_copilot_seat_assignment_for_teams(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Copilot, :cancel_copilot_seat_assignment_for_teams},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec cancel_copilot_seat_assignment_for_users(GitHubEx.Client.t()) :: result
  @spec cancel_copilot_seat_assignment_for_users(GitHubEx.Client.t(), map()) :: result
  def cancel_copilot_seat_assignment_for_users(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Copilot, :cancel_copilot_seat_assignment_for_users},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec copilot_content_exclusion_for_organization(GitHubEx.Client.t()) :: result
  @spec copilot_content_exclusion_for_organization(GitHubEx.Client.t(), map()) :: result
  def copilot_content_exclusion_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :copilot_content_exclusion_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec copilot_metrics_for_organization(GitHubEx.Client.t()) :: result
  @spec copilot_metrics_for_organization(GitHubEx.Client.t(), map()) :: result
  def copilot_metrics_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :copilot_metrics_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec copilot_metrics_for_team(GitHubEx.Client.t()) :: result
  @spec copilot_metrics_for_team(GitHubEx.Client.t(), map()) :: result
  def copilot_metrics_for_team(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :copilot_metrics_for_team},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_copilot_organization_details(GitHubEx.Client.t()) :: result
  @spec get_copilot_organization_details(GitHubEx.Client.t(), map()) :: result
  def get_copilot_organization_details(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :get_copilot_organization_details},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_copilot_seat_details_for_user(GitHubEx.Client.t()) :: result
  @spec get_copilot_seat_details_for_user(GitHubEx.Client.t(), map()) :: result
  def get_copilot_seat_details_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :get_copilot_seat_details_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_copilot_seats(GitHubEx.Client.t()) :: result
  @spec list_copilot_seats(GitHubEx.Client.t(), map()) :: result
  def list_copilot_seats(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Copilot, :list_copilot_seats},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec set_copilot_content_exclusion_for_organization(GitHubEx.Client.t()) :: result
  @spec set_copilot_content_exclusion_for_organization(GitHubEx.Client.t(), map()) :: result
  def set_copilot_content_exclusion_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Copilot, :set_copilot_content_exclusion_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
