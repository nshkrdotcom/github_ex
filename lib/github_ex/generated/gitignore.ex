defmodule GitHubEx.Gitignore do
  ...
  * `gitignore/get-template`
  ...
  @spec get_all_templates(GitHubEx.Client.t()) :: result
  @spec get_all_templates(GitHubEx.Client.t(), map()) :: result
  def get_all_templates(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Gitignore, :get_all_templates},
  ...
  @spec get_template(GitHubEx.Client.t()) :: result
  @spec get_template(GitHubEx.Client.t(), map()) :: result
  def get_template(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Gitignore, :get_template},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
