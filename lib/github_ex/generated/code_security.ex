defmodule GitHubEx.CodeSecurity do
  ...
  * `code-security/get-configuration-for-repository`
  ...
  @spec attach_configuration(GitHubEx.Client.t()) :: result
  @spec attach_configuration(GitHubEx.Client.t(), map()) :: result
  def attach_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :attach_configuration},
  ...
  @spec attach_enterprise_configuration(GitHubEx.Client.t()) :: result
  @spec attach_enterprise_configuration(GitHubEx.Client.t(), map()) :: result
  def attach_enterprise_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :attach_enterprise_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_configuration(GitHubEx.Client.t()) :: result
  @spec create_configuration(GitHubEx.Client.t(), map()) :: result
  def create_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :create_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_configuration_for_enterprise(GitHubEx.Client.t()) :: result
  @spec create_configuration_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def create_configuration_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :create_configuration_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_configuration(GitHubEx.Client.t()) :: result
  @spec delete_configuration(GitHubEx.Client.t(), map()) :: result
  def delete_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :delete_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_configuration_for_enterprise(GitHubEx.Client.t()) :: result
  @spec delete_configuration_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def delete_configuration_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :delete_configuration_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec detach_configuration(GitHubEx.Client.t()) :: result
  @spec detach_configuration(GitHubEx.Client.t(), map()) :: result
  def detach_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :detach_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_configuration(GitHubEx.Client.t()) :: result
  @spec get_configuration(GitHubEx.Client.t(), map()) :: result
  def get_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_configuration_for_repository(GitHubEx.Client.t()) :: result
  @spec get_configuration_for_repository(GitHubEx.Client.t(), map()) :: result
  def get_configuration_for_repository(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_configuration_for_repository},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_configurations_for_enterprise(GitHubEx.Client.t()) :: result
  @spec get_configurations_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def get_configurations_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_configurations_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_configurations_for_org(GitHubEx.Client.t()) :: result
  @spec get_configurations_for_org(GitHubEx.Client.t(), map()) :: result
  def get_configurations_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_configurations_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_default_configurations(GitHubEx.Client.t()) :: result
  @spec get_default_configurations(GitHubEx.Client.t(), map()) :: result
  def get_default_configurations(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_default_configurations},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_default_configurations_for_enterprise(GitHubEx.Client.t()) :: result
  @spec get_default_configurations_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def get_default_configurations_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_default_configurations_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_repositories_for_configuration(GitHubEx.Client.t()) :: result
  @spec get_repositories_for_configuration(GitHubEx.Client.t(), map()) :: result
  def get_repositories_for_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_repositories_for_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_repositories_for_enterprise_configuration(GitHubEx.Client.t()) :: result
  @spec get_repositories_for_enterprise_configuration(GitHubEx.Client.t(), map()) :: result
  def get_repositories_for_enterprise_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_repositories_for_enterprise_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_single_configuration_for_enterprise(GitHubEx.Client.t()) :: result
  @spec get_single_configuration_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def get_single_configuration_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.CodeSecurity, :get_single_configuration_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec set_configuration_as_default(GitHubEx.Client.t()) :: result
  @spec set_configuration_as_default(GitHubEx.Client.t(), map()) :: result
  def set_configuration_as_default(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :set_configuration_as_default},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec set_configuration_as_default_for_enterprise(GitHubEx.Client.t()) :: result
  @spec set_configuration_as_default_for_enterprise(GitHubEx.Client.t(), map()) :: result
  def set_configuration_as_default_for_enterprise(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :set_configuration_as_default_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec update_configuration(GitHubEx.Client.t()) :: result
  @spec update_configuration(GitHubEx.Client.t(), map()) :: result
  def update_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :update_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec update_enterprise_configuration(GitHubEx.Client.t()) :: result
  @spec update_enterprise_configuration(GitHubEx.Client.t(), map()) :: result
  def update_enterprise_configuration(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.CodeSecurity, :update_enterprise_configuration},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
