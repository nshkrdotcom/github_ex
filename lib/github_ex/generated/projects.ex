defmodule GitHubEx.Projects do
  ...
  * `projects/list-view-items-for-user`
  ...
  @spec add_field_for_org(GitHubEx.Client.t()) :: result
  @spec add_field_for_org(GitHubEx.Client.t(), map()) :: result
  def add_field_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :add_field_for_org},
  ...
  @spec add_field_for_user(GitHubEx.Client.t()) :: result
  @spec add_field_for_user(GitHubEx.Client.t(), map()) :: result
  def add_field_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :add_field_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec add_item_for_org(GitHubEx.Client.t()) :: result
  @spec add_item_for_org(GitHubEx.Client.t(), map()) :: result
  def add_item_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :add_item_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec add_item_for_user(GitHubEx.Client.t()) :: result
  @spec add_item_for_user(GitHubEx.Client.t(), map()) :: result
  def add_item_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :add_item_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_draft_item_for_authenticated_user(GitHubEx.Client.t()) :: result
  @spec create_draft_item_for_authenticated_user(GitHubEx.Client.t(), map()) :: result
  def create_draft_item_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :create_draft_item_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_draft_item_for_org(GitHubEx.Client.t()) :: result
  @spec create_draft_item_for_org(GitHubEx.Client.t(), map()) :: result
  def create_draft_item_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :create_draft_item_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_view_for_org(GitHubEx.Client.t()) :: result
  @spec create_view_for_org(GitHubEx.Client.t(), map()) :: result
  def create_view_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :create_view_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_view_for_user(GitHubEx.Client.t()) :: result
  @spec create_view_for_user(GitHubEx.Client.t(), map()) :: result
  def create_view_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :create_view_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_item_for_org(GitHubEx.Client.t()) :: result
  @spec delete_item_for_org(GitHubEx.Client.t(), map()) :: result
  def delete_item_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :delete_item_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_item_for_user(GitHubEx.Client.t()) :: result
  @spec delete_item_for_user(GitHubEx.Client.t(), map()) :: result
  def delete_item_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :delete_item_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_field_for_org(GitHubEx.Client.t()) :: result
  @spec get_field_for_org(GitHubEx.Client.t(), map()) :: result
  def get_field_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_field_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_field_for_user(GitHubEx.Client.t()) :: result
  @spec get_field_for_user(GitHubEx.Client.t(), map()) :: result
  def get_field_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_field_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_for_org(GitHubEx.Client.t()) :: result
  @spec get_for_org(GitHubEx.Client.t(), map()) :: result
  def get_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_for_user(GitHubEx.Client.t()) :: result
  @spec get_for_user(GitHubEx.Client.t(), map()) :: result
  def get_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_org_item(GitHubEx.Client.t()) :: result
  @spec get_org_item(GitHubEx.Client.t(), map()) :: result
  def get_org_item(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_org_item},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_user_item(GitHubEx.Client.t()) :: result
  @spec get_user_item(GitHubEx.Client.t(), map()) :: result
  def get_user_item(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :get_user_item},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_fields_for_org(GitHubEx.Client.t()) :: result
  @spec list_fields_for_org(GitHubEx.Client.t(), map()) :: result
  def list_fields_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_fields_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_fields_for_user(GitHubEx.Client.t()) :: result
  @spec list_fields_for_user(GitHubEx.Client.t(), map()) :: result
  def list_fields_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_fields_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_items_for_org(GitHubEx.Client.t()) :: result
  @spec list_items_for_org(GitHubEx.Client.t(), map()) :: result
  def list_items_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_items_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_items_for_user(GitHubEx.Client.t()) :: result
  @spec list_items_for_user(GitHubEx.Client.t(), map()) :: result
  def list_items_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_items_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_view_items_for_org(GitHubEx.Client.t()) :: result
  @spec list_view_items_for_org(GitHubEx.Client.t(), map()) :: result
  def list_view_items_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_view_items_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_view_items_for_user(GitHubEx.Client.t()) :: result
  @spec list_view_items_for_user(GitHubEx.Client.t(), map()) :: result
  def list_view_items_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.Projects, :list_view_items_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_item_for_org(GitHubEx.Client.t()) :: result
  @spec update_item_for_org(GitHubEx.Client.t(), map()) :: result
  def update_item_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :update_item_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec update_item_for_user(GitHubEx.Client.t()) :: result
  @spec update_item_for_user(GitHubEx.Client.t(), map()) :: result
  def update_item_for_user(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.Projects, :update_item_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
