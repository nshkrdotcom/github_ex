defmodule GitHubEx.HostedCompute do
  ...
  * `hosted-compute/get-network-settings-for-org`
  ...
  @spec create_network_configuration_for_org(GitHubEx.Client.t()) :: result
  @spec create_network_configuration_for_org(GitHubEx.Client.t(), map()) :: result
  def create_network_configuration_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :remaining,
      call: {GitHubEx.HostedCompute, :create_network_configuration_for_org},
  ...
  @spec delete_network_configuration_from_org(GitHubEx.Client.t()) :: result
  @spec delete_network_configuration_from_org(GitHubEx.Client.t(), map()) :: result
  def delete_network_configuration_from_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.HostedCompute, :delete_network_configuration_from_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_network_configuration_for_org(GitHubEx.Client.t()) :: result
  @spec get_network_configuration_for_org(GitHubEx.Client.t(), map()) :: result
  def get_network_configuration_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.HostedCompute, :get_network_configuration_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_network_settings_for_org(GitHubEx.Client.t()) :: result
  @spec get_network_settings_for_org(GitHubEx.Client.t(), map()) :: result
  def get_network_settings_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.HostedCompute, :get_network_settings_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_network_configurations_for_org(GitHubEx.Client.t()) :: result
  @spec list_network_configurations_for_org(GitHubEx.Client.t(), map()) :: result
  def list_network_configurations_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubEx.HostedCompute, :list_network_configurations_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_network_configuration_for_org(GitHubEx.Client.t()) :: result
  @spec update_network_configuration_for_org(GitHubEx.Client.t(), map()) :: result
  def update_network_configuration_for_org(client, params \\ %{}) when is_map(params) do
    GitHubEx.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubEx.HostedCompute, :update_network_configuration_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
