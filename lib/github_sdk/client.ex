defmodule GitHubSDK.Client do
  ...
  def new(opts \\ []) when is_list(opts) do
    ...
    transport_opts =
      normalize_transport_opts(
        ...
        Keyword.get(opts, :finch, GitHubSDK.Finch)
      )
  ...
  @spec request(t(), raw_request_t()) :: {:ok, term()} | {:error, GitHubSDK.Error.t()}
  ...
  def request(other, _request) do
    raise ArgumentError, "expected GitHubSDK.Client, got: #{inspect(other)}"
  end
  ...
  defp build_context(%__MODULE__{} = client) do
    base_opts = [
      ...
      response_wrapper: GitHubSDK.Response,
      result_classifier: GitHubSDK.ResultClassifier,
  ...
  defp default_user_agent do
    "github-sdk-elixir/#{package_version()}"
  end

  defp package_version do
    case Application.spec(:github_sdk, :vsn) do
      nil -> "dev"
  ...
  defp config(key, default) do
    Application.get_env(:github_sdk, key, default)
  end
end
