defmodule GitHubSDK.Apps do
  ...
  * `apps/get-user-installation`
  ...
  @spec add_repo_to_installation_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec add_repo_to_installation_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def add_repo_to_installation_for_authenticated_user(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call: {GitHubSDK.Apps, :add_repo_to_installation_for_authenticated_user},
  ...
  @spec check_token(GitHubSDK.Client.t()) :: result
  @spec check_token(GitHubSDK.Client.t(), map()) :: result
  def check_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :oauth_application,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :check_token},
  ...
  @spec create_from_manifest(GitHubSDK.Client.t()) :: result
  @spec create_from_manifest(GitHubSDK.Client.t(), map()) :: result
  def create_from_manifest(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :create_from_manifest},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_installation_access_token(GitHubSDK.Client.t()) :: result
  @spec create_installation_access_token(GitHubSDK.Client.t(), map()) :: result
  def create_installation_access_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :create_installation_access_token},
  ...
  @spec delete_authorization(GitHubSDK.Client.t()) :: result
  @spec delete_authorization(GitHubSDK.Client.t(), map()) :: result
  def delete_authorization(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :oauth_application,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :delete_authorization},
      circuit_breaker: "oauth",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_installation(GitHubSDK.Client.t()) :: result
  @spec delete_installation(GitHubSDK.Client.t(), map()) :: result
  def delete_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :delete_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_token(GitHubSDK.Client.t()) :: result
  @spec delete_token(GitHubSDK.Client.t(), map()) :: result
  def delete_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :oauth_application,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :delete_token},
      circuit_breaker: "oauth",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  def get_authenticated(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_authenticated},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "Get an app\n\nPath: /apps/{app_slug}\n\nMethod: get"
  @spec get_by_slug(GitHubSDK.Client.t()) :: result
  @spec get_by_slug(GitHubSDK.Client.t(), map()) :: result
  def get_by_slug(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_by_slug},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_installation(GitHubSDK.Client.t()) :: result
  @spec get_installation(GitHubSDK.Client.t(), map()) :: result
  def get_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_org_installation(GitHubSDK.Client.t()) :: result
  @spec get_org_installation(GitHubSDK.Client.t(), map()) :: result
  def get_org_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_org_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_repo_installation(GitHubSDK.Client.t()) :: result
  @spec get_repo_installation(GitHubSDK.Client.t(), map()) :: result
  def get_repo_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_repo_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_subscription_plan_for_account(GitHubSDK.Client.t()) :: result
  @spec get_subscription_plan_for_account(GitHubSDK.Client.t(), map()) :: result
  def get_subscription_plan_for_account(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_subscription_plan_for_account},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_subscription_plan_for_account_stubbed(GitHubSDK.Client.t()) :: result
  @spec get_subscription_plan_for_account_stubbed(GitHubSDK.Client.t(), map()) :: result
  def get_subscription_plan_for_account_stubbed(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_subscription_plan_for_account_stubbed},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_user_installation(GitHubSDK.Client.t()) :: result
  @spec get_user_installation(GitHubSDK.Client.t(), map()) :: result
  def get_user_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_user_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_webhook_config_for_app(GitHubSDK.Client.t()) :: result
  @spec get_webhook_config_for_app(GitHubSDK.Client.t(), map()) :: result
  def get_webhook_config_for_app(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_webhook_config_for_app},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def get_webhook_delivery(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :get_webhook_delivery},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_accounts_for_plan(GitHubSDK.Client.t()) :: result
  @spec list_accounts_for_plan(GitHubSDK.Client.t(), map()) :: result
  def list_accounts_for_plan(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_accounts_for_plan},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_accounts_for_plan_stubbed(GitHubSDK.Client.t()) :: result
  @spec list_accounts_for_plan_stubbed(GitHubSDK.Client.t(), map()) :: result
  def list_accounts_for_plan_stubbed(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_accounts_for_plan_stubbed},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_installation_repos_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_installation_repos_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_installation_repos_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_installation_repos_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_installation_requests_for_authenticated_app(GitHubSDK.Client.t()) :: result
  @spec list_installation_requests_for_authenticated_app(GitHubSDK.Client.t(), map()) :: result
  def list_installation_requests_for_authenticated_app(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_installation_requests_for_authenticated_app},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_installations(GitHubSDK.Client.t()) :: result
  @spec list_installations(GitHubSDK.Client.t(), map()) :: result
  def list_installations(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_installations},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_installations_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_installations_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_installations_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_installations_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_plans(GitHubSDK.Client.t()) :: result
  @spec list_plans(GitHubSDK.Client.t(), map()) :: result
  def list_plans(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_plans},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_plans_stubbed(GitHubSDK.Client.t()) :: result
  @spec list_plans_stubbed(GitHubSDK.Client.t(), map()) :: result
  def list_plans_stubbed(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_plans_stubbed},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_repos_accessible_to_installation(GitHubSDK.Client.t()) :: result
  @spec list_repos_accessible_to_installation(GitHubSDK.Client.t(), map()) :: result
  def list_repos_accessible_to_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_repos_accessible_to_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_subscriptions_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_subscriptions_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_subscriptions_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_subscriptions_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_subscriptions_for_authenticated_user_stubbed(GitHubSDK.Client.t()) :: result
  @spec list_subscriptions_for_authenticated_user_stubbed(GitHubSDK.Client.t(), map()) :: result
  def list_subscriptions_for_authenticated_user_stubbed(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_subscriptions_for_authenticated_user_stubbed},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_webhook_deliveries(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :list_webhook_deliveries},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def redeliver_webhook_delivery(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :redeliver_webhook_delivery},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec remove_repo_from_installation_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec remove_repo_from_installation_for_authenticated_user(GitHubSDK.Client.t(), map()) ::
          result
  def remove_repo_from_installation_for_authenticated_user(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :remove_repo_from_installation_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @doc "Reset a token\n\nPath: /applications/{client_id}/token\n\nMethod: patch"
  @spec reset_token(GitHubSDK.Client.t()) :: result
  @spec reset_token(GitHubSDK.Client.t(), map()) :: result
  def reset_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :oauth_application,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :reset_token},
      circuit_breaker: "oauth",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec revoke_installation_access_token(GitHubSDK.Client.t()) :: result
  @spec revoke_installation_access_token(GitHubSDK.Client.t(), map()) :: result
  def revoke_installation_access_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :revoke_installation_access_token},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec scope_token(GitHubSDK.Client.t()) :: result
  @spec scope_token(GitHubSDK.Client.t(), map()) :: result
  def scope_token(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :oauth_application,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :scope_token},
      circuit_breaker: "oauth",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec suspend_installation(GitHubSDK.Client.t()) :: result
  @spec suspend_installation(GitHubSDK.Client.t(), map()) :: result
  def suspend_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :suspend_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec unsuspend_installation(GitHubSDK.Client.t()) :: result
  @spec unsuspend_installation(GitHubSDK.Client.t(), map()) :: result
  def unsuspend_installation(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Apps, :unsuspend_installation},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec update_webhook_config_for_app(GitHubSDK.Client.t()) :: result
  @spec update_webhook_config_for_app(GitHubSDK.Client.t(), map()) :: result
  def update_webhook_config_for_app(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Apps, :update_webhook_config_for_app},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
