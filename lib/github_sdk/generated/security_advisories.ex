defmodule GitHubSDK.SecurityAdvisories do
  @moduledoc """
  ...
  * `security-advisories/create-fork`
  ...
  def create_fork(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :create_fork},
  ...
  @spec create_private_vulnerability_report(GitHubSDK.Client.t()) :: result
  @spec create_private_vulnerability_report(GitHubSDK.Client.t(), map()) :: result
  def create_private_vulnerability_report(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.SecurityAdvisories, :create_private_vulnerability_report},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_repository_advisory(GitHubSDK.Client.t()) :: result
  @spec create_repository_advisory(GitHubSDK.Client.t(), map()) :: result
  def create_repository_advisory(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.SecurityAdvisories, :create_repository_advisory},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_repository_advisory_cve_request(GitHubSDK.Client.t()) :: result
  @spec create_repository_advisory_cve_request(GitHubSDK.Client.t(), map()) :: result
  def create_repository_advisory_cve_request(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :create_repository_advisory_cve_request},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec get_global_advisory(GitHubSDK.Client.t()) :: result
  @spec get_global_advisory(GitHubSDK.Client.t(), map()) :: result
  def get_global_advisory(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :get_global_advisory},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_repository_advisory(GitHubSDK.Client.t()) :: result
  @spec get_repository_advisory(GitHubSDK.Client.t(), map()) :: result
  def get_repository_advisory(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :get_repository_advisory},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_global_advisories(GitHubSDK.Client.t()) :: result
  @spec list_global_advisories(GitHubSDK.Client.t(), map()) :: result
  def list_global_advisories(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :list_global_advisories},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_org_repository_advisories(GitHubSDK.Client.t()) :: result
  @spec list_org_repository_advisories(GitHubSDK.Client.t(), map()) :: result
  def list_org_repository_advisories(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :list_org_repository_advisories},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_repository_advisories(GitHubSDK.Client.t()) :: result
  @spec list_repository_advisories(GitHubSDK.Client.t(), map()) :: result
  def list_repository_advisories(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecurityAdvisories, :list_repository_advisories},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_repository_advisory(GitHubSDK.Client.t()) :: result
  @spec update_repository_advisory(GitHubSDK.Client.t(), map()) :: result
  def update_repository_advisory(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.SecurityAdvisories, :update_repository_advisory},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
