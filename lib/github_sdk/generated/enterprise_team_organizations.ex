defmodule GitHubSDK.EnterpriseTeamOrganizations do
  @moduledoc """
  ...
  * `enterprise-team-organizations/get-assignment`
  ...
  @spec add(GitHubSDK.Client.t()) :: result
  @spec add(GitHubSDK.Client.t(), map()) :: result
  def add(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :add},
  ...
  @spec bulk_add(GitHubSDK.Client.t()) :: result
  @spec bulk_add(GitHubSDK.Client.t(), map()) :: result
  def bulk_add(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :bulk_add},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec bulk_remove(GitHubSDK.Client.t()) :: result
  @spec bulk_remove(GitHubSDK.Client.t(), map()) :: result
  def bulk_remove(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :bulk_remove},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def delete(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :delete},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_assignment(GitHubSDK.Client.t()) :: result
  @spec get_assignment(GitHubSDK.Client.t(), map()) :: result
  def get_assignment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :get_assignment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_assignments(GitHubSDK.Client.t()) :: result
  @spec get_assignments(GitHubSDK.Client.t(), map()) :: result
  def get_assignments(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamOrganizations, :get_assignments},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
