defmodule GitHubSDK.EnterpriseTeamMemberships do
  @moduledoc """
  ...
  * `enterprise-team-memberships/remove`
  ...
  def add(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamMemberships, :add},
  ...
  def bulk_add(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.EnterpriseTeamMemberships, :bulk_add},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def bulk_remove(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.EnterpriseTeamMemberships, :bulk_remove},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def get(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamMemberships, :get},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamMemberships, :list},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec remove(GitHubSDK.Client.t()) :: result
  @spec remove(GitHubSDK.Client.t(), map()) :: result
  def remove(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.EnterpriseTeamMemberships, :remove},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
