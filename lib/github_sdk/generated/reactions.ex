defmodule GitHubSDK.Reactions do
  @moduledoc """
  ...
  * `reactions/delete-for-release`
  ...
  @spec create_for_commit_comment(GitHubSDK.Client.t()) :: result
  @spec create_for_commit_comment(GitHubSDK.Client.t(), map()) :: result
  def create_for_commit_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Reactions, :create_for_commit_comment},
  ...
  @spec create_for_issue(GitHubSDK.Client.t()) :: result
  @spec create_for_issue(GitHubSDK.Client.t(), map()) :: result
  def create_for_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Reactions, :create_for_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_for_issue_comment(GitHubSDK.Client.t()) :: result
  @spec create_for_issue_comment(GitHubSDK.Client.t(), map()) :: result
  def create_for_issue_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Reactions, :create_for_issue_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_for_pull_request_review_comment(GitHubSDK.Client.t()) :: result
  @spec create_for_pull_request_review_comment(GitHubSDK.Client.t(), map()) :: result
  def create_for_pull_request_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Reactions, :create_for_pull_request_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_for_release(GitHubSDK.Client.t()) :: result
  @spec create_for_release(GitHubSDK.Client.t(), map()) :: result
  def create_for_release(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Reactions, :create_for_release},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_for_commit_comment(GitHubSDK.Client.t()) :: result
  @spec delete_for_commit_comment(GitHubSDK.Client.t(), map()) :: result
  def delete_for_commit_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :delete_for_commit_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_for_issue(GitHubSDK.Client.t()) :: result
  @spec delete_for_issue(GitHubSDK.Client.t(), map()) :: result
  def delete_for_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :delete_for_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_for_issue_comment(GitHubSDK.Client.t()) :: result
  @spec delete_for_issue_comment(GitHubSDK.Client.t(), map()) :: result
  def delete_for_issue_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :delete_for_issue_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_for_pull_request_comment(GitHubSDK.Client.t()) :: result
  @spec delete_for_pull_request_comment(GitHubSDK.Client.t(), map()) :: result
  def delete_for_pull_request_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :delete_for_pull_request_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_for_release(GitHubSDK.Client.t()) :: result
  @spec delete_for_release(GitHubSDK.Client.t(), map()) :: result
  def delete_for_release(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :delete_for_release},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec list_for_commit_comment(GitHubSDK.Client.t()) :: result
  @spec list_for_commit_comment(GitHubSDK.Client.t(), map()) :: result
  def list_for_commit_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :list_for_commit_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_issue(GitHubSDK.Client.t()) :: result
  @spec list_for_issue(GitHubSDK.Client.t(), map()) :: result
  def list_for_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :list_for_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_issue_comment(GitHubSDK.Client.t()) :: result
  @spec list_for_issue_comment(GitHubSDK.Client.t(), map()) :: result
  def list_for_issue_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :list_for_issue_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_pull_request_review_comment(GitHubSDK.Client.t()) :: result
  @spec list_for_pull_request_review_comment(GitHubSDK.Client.t(), map()) :: result
  def list_for_pull_request_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :list_for_pull_request_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_release(GitHubSDK.Client.t()) :: result
  @spec list_for_release(GitHubSDK.Client.t(), map()) :: result
  def list_for_release(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Reactions, :list_for_release},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
