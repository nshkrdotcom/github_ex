defmodule GitHubSDK.Pulls do
  ...
  * `pulls/update-branch`
  ...
  @spec check_if_merged(GitHubSDK.Client.t()) :: result
  @spec check_if_merged(GitHubSDK.Client.t(), map()) :: result
  def check_if_merged(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :check_if_merged},
  ...
  @spec create_reply_for_review_comment(GitHubSDK.Client.t()) :: result
  @spec create_reply_for_review_comment(GitHubSDK.Client.t(), map()) :: result
  def create_reply_for_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :create_reply_for_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_review(GitHubSDK.Client.t()) :: result
  @spec create_review(GitHubSDK.Client.t(), map()) :: result
  def create_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :create_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_review_comment(GitHubSDK.Client.t()) :: result
  @spec create_review_comment(GitHubSDK.Client.t(), map()) :: result
  def create_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :create_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_pending_review(GitHubSDK.Client.t()) :: result
  @spec delete_pending_review(GitHubSDK.Client.t(), map()) :: result
  def delete_pending_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :delete_pending_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_review_comment(GitHubSDK.Client.t()) :: result
  @spec delete_review_comment(GitHubSDK.Client.t(), map()) :: result
  def delete_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :delete_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec dismiss_review(GitHubSDK.Client.t()) :: result
  @spec dismiss_review(GitHubSDK.Client.t(), map()) :: result
  def dismiss_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :dismiss_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec get_review(GitHubSDK.Client.t()) :: result
  @spec get_review(GitHubSDK.Client.t(), map()) :: result
  def get_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :get_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_review_comment(GitHubSDK.Client.t()) :: result
  @spec get_review_comment(GitHubSDK.Client.t(), map()) :: result
  def get_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :get_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_comments_for_review(GitHubSDK.Client.t()) :: result
  @spec list_comments_for_review(GitHubSDK.Client.t(), map()) :: result
  def list_comments_for_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_comments_for_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_commits(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_commits},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_files(GitHubSDK.Client.t()) :: result
  @spec list_files(GitHubSDK.Client.t(), map()) :: result
  def list_files(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_files},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_requested_reviewers(GitHubSDK.Client.t()) :: result
  @spec list_requested_reviewers(GitHubSDK.Client.t(), map()) :: result
  def list_requested_reviewers(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_requested_reviewers},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_review_comments(GitHubSDK.Client.t()) :: result
  @spec list_review_comments(GitHubSDK.Client.t(), map()) :: result
  def list_review_comments(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_review_comments},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_review_comments_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_review_comments_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_review_comments_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_review_comments_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_reviews(GitHubSDK.Client.t()) :: result
  @spec list_reviews(GitHubSDK.Client.t(), map()) :: result
  def list_reviews(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Pulls, :list_reviews},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec remove_requested_reviewers(GitHubSDK.Client.t()) :: result
  @spec remove_requested_reviewers(GitHubSDK.Client.t(), map()) :: result
  def remove_requested_reviewers(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :remove_requested_reviewers},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec request_reviewers(GitHubSDK.Client.t()) :: result
  @spec request_reviewers(GitHubSDK.Client.t(), map()) :: result
  def request_reviewers(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :request_reviewers},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec submit_review(GitHubSDK.Client.t()) :: result
  @spec submit_review(GitHubSDK.Client.t(), map()) :: result
  def submit_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :submit_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec update_branch(GitHubSDK.Client.t()) :: result
  @spec update_branch(GitHubSDK.Client.t(), map()) :: result
  def update_branch(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :update_branch},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec update_review(GitHubSDK.Client.t()) :: result
  @spec update_review(GitHubSDK.Client.t(), map()) :: result
  def update_review(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :update_review},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec update_review_comment(GitHubSDK.Client.t()) :: result
  @spec update_review_comment(GitHubSDK.Client.t(), map()) :: result
  def update_review_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Pulls, :update_review_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
