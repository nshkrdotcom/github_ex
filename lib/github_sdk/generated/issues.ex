defmodule GitHubSDK.Issues do
  ...
  * `issues/list-for-authenticated-user`
  ...
  @spec add_assignees(GitHubSDK.Client.t()) :: result
  @spec add_assignees(GitHubSDK.Client.t(), map()) :: result
  def add_assignees(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :add_assignees},
  ...
  @spec add_blocked_by_dependency(GitHubSDK.Client.t()) :: result
  @spec add_blocked_by_dependency(GitHubSDK.Client.t(), map()) :: result
  def add_blocked_by_dependency(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :add_blocked_by_dependency},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec add_issue_field_values(GitHubSDK.Client.t()) :: result
  @spec add_issue_field_values(GitHubSDK.Client.t(), map()) :: result
  def add_issue_field_values(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :add_issue_field_values},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec add_labels(GitHubSDK.Client.t()) :: result
  @spec add_labels(GitHubSDK.Client.t(), map()) :: result
  def add_labels(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :add_labels},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec add_sub_issue(GitHubSDK.Client.t()) :: result
  @spec add_sub_issue(GitHubSDK.Client.t(), map()) :: result
  def add_sub_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :add_sub_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec check_user_can_be_assigned(GitHubSDK.Client.t()) :: result
  @spec check_user_can_be_assigned(GitHubSDK.Client.t(), map()) :: result
  def check_user_can_be_assigned(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :check_user_can_be_assigned},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec check_user_can_be_assigned_to_issue(GitHubSDK.Client.t()) :: result
  @spec check_user_can_be_assigned_to_issue(GitHubSDK.Client.t(), map()) :: result
  def check_user_can_be_assigned_to_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :check_user_can_be_assigned_to_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def create_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :create_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_label(GitHubSDK.Client.t()) :: result
  @spec create_label(GitHubSDK.Client.t(), map()) :: result
  def create_label(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :create_label},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_milestone(GitHubSDK.Client.t()) :: result
  @spec create_milestone(GitHubSDK.Client.t(), map()) :: result
  def create_milestone(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :create_milestone},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def delete_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :delete_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_issue_field_value(GitHubSDK.Client.t()) :: result
  @spec delete_issue_field_value(GitHubSDK.Client.t(), map()) :: result
  def delete_issue_field_value(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :delete_issue_field_value},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_label(GitHubSDK.Client.t()) :: result
  @spec delete_label(GitHubSDK.Client.t(), map()) :: result
  def delete_label(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :delete_label},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_milestone(GitHubSDK.Client.t()) :: result
  @spec delete_milestone(GitHubSDK.Client.t(), map()) :: result
  def delete_milestone(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :delete_milestone},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  def get_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :get_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_event(GitHubSDK.Client.t()) :: result
  @spec get_event(GitHubSDK.Client.t(), map()) :: result
  def get_event(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :get_event},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "Get a label\n\nPath: /repos/{owner}/{repo}/labels/{name}\n\nMethod: get"
  @spec get_label(GitHubSDK.Client.t()) :: result
  @spec get_label(GitHubSDK.Client.t(), map()) :: result
  def get_label(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :get_label},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "Get a milestone\n\nPath: /repos/{owner}/{repo}/milestones/{milestone_number}\n\nMethod: get"
  @spec get_milestone(GitHubSDK.Client.t()) :: result
  @spec get_milestone(GitHubSDK.Client.t(), map()) :: result
  def get_milestone(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :get_milestone},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_parent(GitHubSDK.Client.t()) :: result
  @spec get_parent(GitHubSDK.Client.t(), map()) :: result
  def get_parent(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :get_parent},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_assignees(GitHubSDK.Client.t()) :: result
  @spec list_assignees(GitHubSDK.Client.t(), map()) :: result
  def list_assignees(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_assignees},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_comments(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_comments},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_comments_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_comments_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_comments_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_comments_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_dependencies_blocked_by(GitHubSDK.Client.t()) :: result
  @spec list_dependencies_blocked_by(GitHubSDK.Client.t(), map()) :: result
  def list_dependencies_blocked_by(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_dependencies_blocked_by},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_dependencies_blocking(GitHubSDK.Client.t()) :: result
  @spec list_dependencies_blocking(GitHubSDK.Client.t(), map()) :: result
  def list_dependencies_blocking(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_dependencies_blocking},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_events(GitHubSDK.Client.t()) :: result
  @spec list_events(GitHubSDK.Client.t(), map()) :: result
  def list_events(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_events},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_events_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_events_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_events_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_events_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_events_for_timeline(GitHubSDK.Client.t()) :: result
  @spec list_events_for_timeline(GitHubSDK.Client.t(), map()) :: result
  def list_events_for_timeline(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_events_for_timeline},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_issue_field_values_for_issue(GitHubSDK.Client.t()) :: result
  @spec list_issue_field_values_for_issue(GitHubSDK.Client.t(), map()) :: result
  def list_issue_field_values_for_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_issue_field_values_for_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_labels_for_milestone(GitHubSDK.Client.t()) :: result
  @spec list_labels_for_milestone(GitHubSDK.Client.t(), map()) :: result
  def list_labels_for_milestone(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_labels_for_milestone},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_labels_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_labels_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_labels_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_labels_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_labels_on_issue(GitHubSDK.Client.t()) :: result
  @spec list_labels_on_issue(GitHubSDK.Client.t(), map()) :: result
  def list_labels_on_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_labels_on_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "List milestones\n\nPath: /repos/{owner}/{repo}/milestones\n\nMethod: get"
  @spec list_milestones(GitHubSDK.Client.t()) :: result
  @spec list_milestones(GitHubSDK.Client.t(), map()) :: result
  def list_milestones(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_milestones},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "List sub-issues\n\nPath: /repos/{owner}/{repo}/issues/{issue_number}/sub_issues\n\nMethod: get"
  @spec list_sub_issues(GitHubSDK.Client.t()) :: result
  @spec list_sub_issues(GitHubSDK.Client.t(), map()) :: result
  def list_sub_issues(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :list_sub_issues},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec lock(GitHubSDK.Client.t()) :: result
  @spec lock(GitHubSDK.Client.t(), map()) :: result
  def lock(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :lock},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec pin_comment(GitHubSDK.Client.t()) :: result
  @spec pin_comment(GitHubSDK.Client.t(), map()) :: result
  def pin_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :pin_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec remove_all_labels(GitHubSDK.Client.t()) :: result
  @spec remove_all_labels(GitHubSDK.Client.t(), map()) :: result
  def remove_all_labels(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :remove_all_labels},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec remove_assignees(GitHubSDK.Client.t()) :: result
  @spec remove_assignees(GitHubSDK.Client.t(), map()) :: result
  def remove_assignees(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :remove_assignees},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec remove_dependency_blocked_by(GitHubSDK.Client.t()) :: result
  @spec remove_dependency_blocked_by(GitHubSDK.Client.t(), map()) :: result
  def remove_dependency_blocked_by(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :remove_dependency_blocked_by},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec remove_label(GitHubSDK.Client.t()) :: result
  @spec remove_label(GitHubSDK.Client.t(), map()) :: result
  def remove_label(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :remove_label},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec remove_sub_issue(GitHubSDK.Client.t()) :: result
  @spec remove_sub_issue(GitHubSDK.Client.t(), map()) :: result
  def remove_sub_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :remove_sub_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec reprioritize_sub_issue(GitHubSDK.Client.t()) :: result
  @spec reprioritize_sub_issue(GitHubSDK.Client.t(), map()) :: result
  def reprioritize_sub_issue(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :reprioritize_sub_issue},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec set_issue_field_values(GitHubSDK.Client.t()) :: result
  @spec set_issue_field_values(GitHubSDK.Client.t(), map()) :: result
  def set_issue_field_values(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :set_issue_field_values},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec set_labels(GitHubSDK.Client.t()) :: result
  @spec set_labels(GitHubSDK.Client.t(), map()) :: result
  def set_labels(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :set_labels},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @doc "Unlock an issue\n\nPath: /repos/{owner}/{repo}/issues/{issue_number}/lock\n\nMethod: delete"
  @spec unlock(GitHubSDK.Client.t()) :: result
  @spec unlock(GitHubSDK.Client.t(), map()) :: result
  def unlock(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :unlock},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec unpin_comment(GitHubSDK.Client.t()) :: result
  @spec unpin_comment(GitHubSDK.Client.t(), map()) :: result
  def unpin_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Issues, :unpin_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  def update_comment(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :update_comment},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @doc "Update a label\n\nPath: /repos/{owner}/{repo}/labels/{name}\n\nMethod: patch"
  @spec update_label(GitHubSDK.Client.t()) :: result
  @spec update_label(GitHubSDK.Client.t(), map()) :: result
  def update_label(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :update_label},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec update_milestone(GitHubSDK.Client.t()) :: result
  @spec update_milestone(GitHubSDK.Client.t(), map()) :: result
  def update_milestone(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Issues, :update_milestone},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
