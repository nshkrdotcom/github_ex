defmodule GitHubSDK.Billing do
  @moduledoc """
  ...
  * `billing/get-github-billing-usage-summary-report-user`
  ...
  @spec delete_budget_org(GitHubSDK.Client.t()) :: result
  @spec delete_budget_org(GitHubSDK.Client.t(), map()) :: result
  def delete_budget_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :delete_budget_org},
  ...
  @spec get_all_budgets_org(GitHubSDK.Client.t()) :: result
  @spec get_all_budgets_org(GitHubSDK.Client.t(), map()) :: result
  def get_all_budgets_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_all_budgets_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_budget_org(GitHubSDK.Client.t()) :: result
  @spec get_budget_org(GitHubSDK.Client.t(), map()) :: result
  def get_budget_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_budget_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_premium_request_usage_report_org(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_premium_request_usage_report_org(GitHubSDK.Client.t(), map()) :: result
  def get_github_billing_premium_request_usage_report_org(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_premium_request_usage_report_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_premium_request_usage_report_user(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_premium_request_usage_report_user(GitHubSDK.Client.t(), map()) ::
          result
  def get_github_billing_premium_request_usage_report_user(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_premium_request_usage_report_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_usage_report_org(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_usage_report_org(GitHubSDK.Client.t(), map()) :: result
  def get_github_billing_usage_report_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_usage_report_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_usage_report_user(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_usage_report_user(GitHubSDK.Client.t(), map()) :: result
  def get_github_billing_usage_report_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_usage_report_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_usage_summary_report_org(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_usage_summary_report_org(GitHubSDK.Client.t(), map()) :: result
  def get_github_billing_usage_summary_report_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_usage_summary_report_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_github_billing_usage_summary_report_user(GitHubSDK.Client.t()) :: result
  @spec get_github_billing_usage_summary_report_user(GitHubSDK.Client.t(), map()) :: result
  def get_github_billing_usage_summary_report_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Billing, :get_github_billing_usage_summary_report_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_budget_org(GitHubSDK.Client.t()) :: result
  @spec update_budget_org(GitHubSDK.Client.t(), map()) :: result
  def update_budget_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Billing, :update_budget_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
