defmodule GitHubSDK.CodeScanning do
  @moduledoc """
  ...
  * `code-scanning/get-sarif`
  ...
  @spec commit_autofix(GitHubSDK.Client.t()) :: result
  @spec commit_autofix(GitHubSDK.Client.t(), map()) :: result
  def commit_autofix(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.CodeScanning, :commit_autofix},
  ...
  @spec create_autofix(GitHubSDK.Client.t()) :: result
  @spec create_autofix(GitHubSDK.Client.t(), map()) :: result
  def create_autofix(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :create_autofix},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_variant_analysis(GitHubSDK.Client.t()) :: result
  @spec create_variant_analysis(GitHubSDK.Client.t(), map()) :: result
  def create_variant_analysis(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.CodeScanning, :create_variant_analysis},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_analysis(GitHubSDK.Client.t()) :: result
  @spec delete_analysis(GitHubSDK.Client.t(), map()) :: result
  def delete_analysis(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :delete_analysis},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_codeql_database(GitHubSDK.Client.t()) :: result
  @spec delete_codeql_database(GitHubSDK.Client.t(), map()) :: result
  def delete_codeql_database(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :delete_codeql_database},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_alert(GitHubSDK.Client.t()) :: result
  @spec get_alert(GitHubSDK.Client.t(), map()) :: result
  def get_alert(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_alert},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_analysis(GitHubSDK.Client.t()) :: result
  @spec get_analysis(GitHubSDK.Client.t(), map()) :: result
  def get_analysis(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_analysis},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_autofix(GitHubSDK.Client.t()) :: result
  @spec get_autofix(GitHubSDK.Client.t(), map()) :: result
  def get_autofix(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_autofix},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_codeql_database(GitHubSDK.Client.t()) :: result
  @spec get_codeql_database(GitHubSDK.Client.t(), map()) :: result
  def get_codeql_database(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_codeql_database},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_default_setup(GitHubSDK.Client.t()) :: result
  @spec get_default_setup(GitHubSDK.Client.t(), map()) :: result
  def get_default_setup(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_default_setup},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_sarif(GitHubSDK.Client.t()) :: result
  @spec get_sarif(GitHubSDK.Client.t(), map()) :: result
  def get_sarif(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_sarif},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_variant_analysis(GitHubSDK.Client.t()) :: result
  @spec get_variant_analysis(GitHubSDK.Client.t(), map()) :: result
  def get_variant_analysis(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_variant_analysis},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_variant_analysis_repo_task(GitHubSDK.Client.t()) :: result
  @spec get_variant_analysis_repo_task(GitHubSDK.Client.t(), map()) :: result
  def get_variant_analysis_repo_task(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :get_variant_analysis_repo_task},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_alert_instances(GitHubSDK.Client.t()) :: result
  @spec list_alert_instances(GitHubSDK.Client.t(), map()) :: result
  def list_alert_instances(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :list_alert_instances},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_alerts_for_org(GitHubSDK.Client.t()) :: result
  @spec list_alerts_for_org(GitHubSDK.Client.t(), map()) :: result
  def list_alerts_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :list_alerts_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_alerts_for_repo(GitHubSDK.Client.t()) :: result
  @spec list_alerts_for_repo(GitHubSDK.Client.t(), map()) :: result
  def list_alerts_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :list_alerts_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_codeql_databases(GitHubSDK.Client.t()) :: result
  @spec list_codeql_databases(GitHubSDK.Client.t(), map()) :: result
  def list_codeql_databases(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :list_codeql_databases},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_recent_analyses(GitHubSDK.Client.t()) :: result
  @spec list_recent_analyses(GitHubSDK.Client.t(), map()) :: result
  def list_recent_analyses(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.CodeScanning, :list_recent_analyses},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_alert(GitHubSDK.Client.t()) :: result
  @spec update_alert(GitHubSDK.Client.t(), map()) :: result
  def update_alert(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.CodeScanning, :update_alert},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec update_default_setup(GitHubSDK.Client.t()) :: result
  @spec update_default_setup(GitHubSDK.Client.t(), map()) :: result
  def update_default_setup(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.CodeScanning, :update_default_setup},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec upload_sarif(GitHubSDK.Client.t()) :: result
  @spec upload_sarif(GitHubSDK.Client.t(), map()) :: result
  def upload_sarif(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.CodeScanning, :upload_sarif},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
