defmodule GitHubSDK.SecretScanning do
  @moduledoc """
  ...
  * `secret-scanning/get-scan-history`
  ...
  @spec create_push_protection_bypass(GitHubSDK.Client.t()) :: result
  @spec create_push_protection_bypass(GitHubSDK.Client.t(), map()) :: result
  def create_push_protection_bypass(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :remaining,
      call: {GitHubSDK.SecretScanning, :create_push_protection_bypass},
  ...
  def get_alert(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :get_alert},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_scan_history(GitHubSDK.Client.t()) :: result
  @spec get_scan_history(GitHubSDK.Client.t(), map()) :: result
  def get_scan_history(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :get_scan_history},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_alerts_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :list_alerts_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_alerts_for_repo(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :list_alerts_for_repo},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_locations_for_alert(GitHubSDK.Client.t()) :: result
  @spec list_locations_for_alert(GitHubSDK.Client.t(), map()) :: result
  def list_locations_for_alert(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :list_locations_for_alert},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_org_pattern_configs(GitHubSDK.Client.t()) :: result
  @spec list_org_pattern_configs(GitHubSDK.Client.t(), map()) :: result
  def list_org_pattern_configs(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.SecretScanning, :list_org_pattern_configs},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def update_alert(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.SecretScanning, :update_alert},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @spec update_org_pattern_configs(GitHubSDK.Client.t()) :: result
  @spec update_org_pattern_configs(GitHubSDK.Client.t(), map()) :: result
  def update_org_pattern_configs(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.SecretScanning, :update_org_pattern_configs},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
