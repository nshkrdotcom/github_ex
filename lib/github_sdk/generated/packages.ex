defmodule GitHubSDK.Packages do
  @moduledoc """
  ...
  * `packages/restore-package-version-for-user`
  ...
  @spec delete_package_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_package_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_package_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_for_authenticated_user},
  ...
  @spec delete_package_for_org(GitHubSDK.Client.t()) :: result
  @spec delete_package_for_org(GitHubSDK.Client.t(), map()) :: result
  def delete_package_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_package_for_user(GitHubSDK.Client.t()) :: result
  @spec delete_package_for_user(GitHubSDK.Client.t(), map()) :: result
  def delete_package_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_package_version_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_package_version_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_package_version_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_version_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_package_version_for_org(GitHubSDK.Client.t()) :: result
  @spec delete_package_version_for_org(GitHubSDK.Client.t(), map()) :: result
  def delete_package_version_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_version_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_package_version_for_user(GitHubSDK.Client.t()) :: result
  @spec delete_package_version_for_user(GitHubSDK.Client.t(), map()) :: result
  def delete_package_version_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :delete_package_version_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_all_package_versions_for_package_owned_by_authenticated_user(GitHubSDK.Client.t()) ::
          result
  ...
  def get_all_package_versions_for_package_owned_by_authenticated_user(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call:
        {GitHubSDK.Packages, :get_all_package_versions_for_package_owned_by_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_all_package_versions_for_package_owned_by_org(GitHubSDK.Client.t()) :: result
  @spec get_all_package_versions_for_package_owned_by_org(GitHubSDK.Client.t(), map()) :: result
  def get_all_package_versions_for_package_owned_by_org(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_all_package_versions_for_package_owned_by_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_all_package_versions_for_package_owned_by_user(GitHubSDK.Client.t()) :: result
  @spec get_all_package_versions_for_package_owned_by_user(GitHubSDK.Client.t(), map()) :: result
  def get_all_package_versions_for_package_owned_by_user(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_all_package_versions_for_package_owned_by_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec get_package_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def get_package_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_for_organization(GitHubSDK.Client.t()) :: result
  @spec get_package_for_organization(GitHubSDK.Client.t(), map()) :: result
  def get_package_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_for_user(GitHubSDK.Client.t()) :: result
  @spec get_package_for_user(GitHubSDK.Client.t(), map()) :: result
  def get_package_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_version_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec get_package_version_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def get_package_version_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_version_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_version_for_organization(GitHubSDK.Client.t()) :: result
  @spec get_package_version_for_organization(GitHubSDK.Client.t(), map()) :: result
  def get_package_version_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_version_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_package_version_for_user(GitHubSDK.Client.t()) :: result
  @spec get_package_version_for_user(GitHubSDK.Client.t(), map()) :: result
  def get_package_version_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :get_package_version_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_docker_migration_conflicting_packages_for_authenticated_user(GitHubSDK.Client.t()) ::
          result
  ...
  def list_docker_migration_conflicting_packages_for_authenticated_user(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :none,
      call:
        {GitHubSDK.Packages, :list_docker_migration_conflicting_packages_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_docker_migration_conflicting_packages_for_organization(GitHubSDK.Client.t()) ::
          result
  @spec list_docker_migration_conflicting_packages_for_organization(GitHubSDK.Client.t(), map()) ::
          result
  def list_docker_migration_conflicting_packages_for_organization(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :list_docker_migration_conflicting_packages_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_docker_migration_conflicting_packages_for_user(GitHubSDK.Client.t()) :: result
  @spec list_docker_migration_conflicting_packages_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_docker_migration_conflicting_packages_for_user(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :list_docker_migration_conflicting_packages_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_packages_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_packages_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_packages_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :list_packages_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_packages_for_organization(GitHubSDK.Client.t()) :: result
  @spec list_packages_for_organization(GitHubSDK.Client.t(), map()) :: result
  def list_packages_for_organization(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :list_packages_for_organization},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_packages_for_user(GitHubSDK.Client.t()) :: result
  @spec list_packages_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_packages_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :list_packages_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec restore_package_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec restore_package_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def restore_package_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec restore_package_for_org(GitHubSDK.Client.t()) :: result
  @spec restore_package_for_org(GitHubSDK.Client.t(), map()) :: result
  def restore_package_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec restore_package_for_user(GitHubSDK.Client.t()) :: result
  @spec restore_package_for_user(GitHubSDK.Client.t(), map()) :: result
  def restore_package_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec restore_package_version_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec restore_package_version_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def restore_package_version_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_version_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec restore_package_version_for_org(GitHubSDK.Client.t()) :: result
  @spec restore_package_version_for_org(GitHubSDK.Client.t(), map()) :: result
  def restore_package_version_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_version_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec restore_package_version_for_user(GitHubSDK.Client.t()) :: result
  @spec restore_package_version_for_user(GitHubSDK.Client.t(), map()) :: result
  def restore_package_version_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Packages, :restore_package_version_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
