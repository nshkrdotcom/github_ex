defmodule GitHubSDK.Users do
  ...
  * `users/list-ssh-signing-keys-for-user`
  ...
  @spec add_email_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec add_email_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def add_email_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :remaining,
      call: {GitHubSDK.Users, :add_email_for_authenticated_user},
  ...
  @spec add_social_account_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec add_social_account_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def add_social_account_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :add_social_account_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec block(GitHubSDK.Client.t()) :: result
  @spec block(GitHubSDK.Client.t(), map()) :: result
  def block(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :block},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec check_blocked(GitHubSDK.Client.t()) :: result
  @spec check_blocked(GitHubSDK.Client.t(), map()) :: result
  def check_blocked(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :check_blocked},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec check_following_for_user(GitHubSDK.Client.t()) :: result
  @spec check_following_for_user(GitHubSDK.Client.t(), map()) :: result
  def check_following_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :check_following_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec check_person_is_followed_by_authenticated(GitHubSDK.Client.t()) :: result
  @spec check_person_is_followed_by_authenticated(GitHubSDK.Client.t(), map()) :: result
  def check_person_is_followed_by_authenticated(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :check_person_is_followed_by_authenticated},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec create_gpg_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec create_gpg_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def create_gpg_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :create_gpg_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec create_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def create_public_ssh_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :create_public_ssh_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec create_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec create_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def create_ssh_signing_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :create_ssh_signing_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def delete_attestations_bulk(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :delete_attestations_bulk},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  def delete_attestations_by_id(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :delete_attestations_by_id},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  def delete_attestations_by_subject_digest(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :delete_attestations_by_subject_digest},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_email_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_email_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_email_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :delete_email_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_gpg_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_gpg_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_gpg_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :delete_gpg_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_public_ssh_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :delete_public_ssh_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_social_account_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_social_account_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_social_account_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :delete_social_account_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec delete_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def delete_ssh_signing_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :delete_ssh_signing_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @doc "Follow a user\n\nPath: /user/following/{username}\n\nMethod: put"
  @spec follow(GitHubSDK.Client.t()) :: result
  @spec follow(GitHubSDK.Client.t(), map()) :: result
  def follow(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :follow},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
  ...
  @spec get_authenticated(GitHubSDK.Client.t()) :: result
  @spec get_authenticated(GitHubSDK.Client.t(), map()) :: result
  def get_authenticated(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_authenticated},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_by_id(GitHubSDK.Client.t()) :: result
  @spec get_by_id(GitHubSDK.Client.t(), map()) :: result
  def get_by_id(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_by_id},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @doc "Get a user\n\nPath: /users/{username}\n\nMethod: get"
  @spec get_by_username(GitHubSDK.Client.t()) :: result
  @spec get_by_username(GitHubSDK.Client.t(), map()) :: result
  def get_by_username(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_by_username},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_context_for_user(GitHubSDK.Client.t()) :: result
  @spec get_context_for_user(GitHubSDK.Client.t(), map()) :: result
  def get_context_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_context_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_gpg_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec get_gpg_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def get_gpg_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_gpg_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec get_public_ssh_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def get_public_ssh_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_public_ssh_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec get_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec get_ssh_signing_key_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def get_ssh_signing_key_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :get_ssh_signing_key_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_attestations(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_attestations},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  def list_attestations_bulk(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :list_attestations_bulk},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec list_blocked_by_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_blocked_by_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_blocked_by_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_blocked_by_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_emails_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_emails_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_emails_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_emails_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_followed_by_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_followed_by_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_followed_by_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_followed_by_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_followers_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_followers_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_followers_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_followers_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_followers_for_user(GitHubSDK.Client.t()) :: result
  @spec list_followers_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_followers_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_followers_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_following_for_user(GitHubSDK.Client.t()) :: result
  @spec list_following_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_following_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_following_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_gpg_keys_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_gpg_keys_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_gpg_keys_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_gpg_keys_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_gpg_keys_for_user(GitHubSDK.Client.t()) :: result
  @spec list_gpg_keys_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_gpg_keys_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_gpg_keys_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_public_emails_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_public_emails_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_public_emails_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_public_emails_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_public_keys_for_user(GitHubSDK.Client.t()) :: result
  @spec list_public_keys_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_public_keys_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_public_keys_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_public_ssh_keys_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_public_ssh_keys_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_public_ssh_keys_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_public_ssh_keys_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_social_accounts_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_social_accounts_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_social_accounts_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_social_accounts_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_social_accounts_for_user(GitHubSDK.Client.t()) :: result
  @spec list_social_accounts_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_social_accounts_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_social_accounts_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_ssh_signing_keys_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec list_ssh_signing_keys_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def list_ssh_signing_keys_for_authenticated_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_ssh_signing_keys_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_ssh_signing_keys_for_user(GitHubSDK.Client.t()) :: result
  @spec list_ssh_signing_keys_for_user(GitHubSDK.Client.t(), map()) :: result
  def list_ssh_signing_keys_for_user(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :list_ssh_signing_keys_for_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec set_primary_email_visibility_for_authenticated_user(GitHubSDK.Client.t()) :: result
  @spec set_primary_email_visibility_for_authenticated_user(GitHubSDK.Client.t(), map()) :: result
  def set_primary_email_visibility_for_authenticated_user(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :set_primary_email_visibility_for_authenticated_user},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
  ...
  @doc "Unblock a user\n\nPath: /user/blocks/{username}\n\nMethod: delete"
  @spec unblock(GitHubSDK.Client.t()) :: result
  @spec unblock(GitHubSDK.Client.t(), map()) :: result
  def unblock(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :unblock},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @doc "Unfollow a user\n\nPath: /user/following/{username}\n\nMethod: delete"
  @spec unfollow(GitHubSDK.Client.t()) :: result
  @spec unfollow(GitHubSDK.Client.t(), map()) :: result
  def unfollow(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Users, :unfollow},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec update_authenticated(GitHubSDK.Client.t()) :: result
  @spec update_authenticated(GitHubSDK.Client.t(), map()) :: result
  def update_authenticated(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Users, :update_authenticated},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
