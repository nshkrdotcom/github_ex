defmodule GitHubSDK.Campaigns do
  @moduledoc """
  ...
  * `campaigns/update-campaign`
  ...
  @spec create_campaign(GitHubSDK.Client.t()) :: result
  @spec create_campaign(GitHubSDK.Client.t(), map()) :: result
  def create_campaign(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Campaigns, :create_campaign},
  ...
  @spec delete_campaign(GitHubSDK.Client.t()) :: result
  @spec delete_campaign(GitHubSDK.Client.t(), map()) :: result
  def delete_campaign(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Campaigns, :delete_campaign},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_campaign_summary(GitHubSDK.Client.t()) :: result
  @spec get_campaign_summary(GitHubSDK.Client.t(), map()) :: result
  def get_campaign_summary(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Campaigns, :get_campaign_summary},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_org_campaigns(GitHubSDK.Client.t()) :: result
  @spec list_org_campaigns(GitHubSDK.Client.t(), map()) :: result
  def list_org_campaigns(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Campaigns, :list_org_campaigns},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_campaign(GitHubSDK.Client.t()) :: result
  @spec update_campaign(GitHubSDK.Client.t(), map()) :: result
  def update_campaign(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Campaigns, :update_campaign},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
