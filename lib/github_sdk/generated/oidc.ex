defmodule GitHubSDK.Oidc do
  ...
  * `oidc/update-oidc-custom-sub-template-for-org`
  ...
  @spec create_oidc_custom_property_inclusion_for_enterprise(GitHubSDK.Client.t()) :: result
  @spec create_oidc_custom_property_inclusion_for_enterprise(GitHubSDK.Client.t(), map()) ::
          result
  def create_oidc_custom_property_inclusion_for_enterprise(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      ...
      body_mode: :remaining,
      call: {GitHubSDK.Oidc, :create_oidc_custom_property_inclusion_for_enterprise},
  ...
  @spec create_oidc_custom_property_inclusion_for_org(GitHubSDK.Client.t()) :: result
  @spec create_oidc_custom_property_inclusion_for_org(GitHubSDK.Client.t(), map()) :: result
  def create_oidc_custom_property_inclusion_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Oidc, :create_oidc_custom_property_inclusion_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec delete_oidc_custom_property_inclusion_for_enterprise(GitHubSDK.Client.t()) :: result
  @spec delete_oidc_custom_property_inclusion_for_enterprise(GitHubSDK.Client.t(), map()) ::
          result
  def delete_oidc_custom_property_inclusion_for_enterprise(client, params \\ %{})
    ...
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Oidc, :delete_oidc_custom_property_inclusion_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec delete_oidc_custom_property_inclusion_for_org(GitHubSDK.Client.t()) :: result
  @spec delete_oidc_custom_property_inclusion_for_org(GitHubSDK.Client.t(), map()) :: result
  def delete_oidc_custom_property_inclusion_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Oidc, :delete_oidc_custom_property_inclusion_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :delete,
  ...
  @spec get_oidc_custom_sub_template_for_org(GitHubSDK.Client.t()) :: result
  @spec get_oidc_custom_sub_template_for_org(GitHubSDK.Client.t(), map()) :: result
  def get_oidc_custom_sub_template_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Oidc, :get_oidc_custom_sub_template_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_oidc_custom_property_inclusions_for_enterprise(GitHubSDK.Client.t()) :: result
  @spec list_oidc_custom_property_inclusions_for_enterprise(GitHubSDK.Client.t(), map()) :: result
  def list_oidc_custom_property_inclusions_for_enterprise(client, params \\ %{})
      when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Oidc, :list_oidc_custom_property_inclusions_for_enterprise},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_oidc_custom_property_inclusions_for_org(GitHubSDK.Client.t()) :: result
  @spec list_oidc_custom_property_inclusions_for_org(GitHubSDK.Client.t(), map()) :: result
  def list_oidc_custom_property_inclusions_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Oidc, :list_oidc_custom_property_inclusions_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec update_oidc_custom_sub_template_for_org(GitHubSDK.Client.t()) :: result
  @spec update_oidc_custom_sub_template_for_org(GitHubSDK.Client.t(), map()) :: result
  def update_oidc_custom_sub_template_for_org(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Oidc, :update_oidc_custom_sub_template_for_org},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :put,
