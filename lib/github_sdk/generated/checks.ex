defmodule GitHubSDK.Checks do
  ...
  * `checks/list-suites-for-ref`
  ...
  @spec create_suite(GitHubSDK.Client.t()) :: result
  @spec create_suite(GitHubSDK.Client.t(), map()) :: result
  def create_suite(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Checks, :create_suite},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec get_suite(GitHubSDK.Client.t()) :: result
  @spec get_suite(GitHubSDK.Client.t(), map()) :: result
  def get_suite(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :get_suite},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_annotations(GitHubSDK.Client.t()) :: result
  @spec list_annotations(GitHubSDK.Client.t(), map()) :: result
  def list_annotations(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :list_annotations},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_ref(GitHubSDK.Client.t()) :: result
  @spec list_for_ref(GitHubSDK.Client.t(), map()) :: result
  def list_for_ref(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :list_for_ref},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_for_suite(GitHubSDK.Client.t()) :: result
  @spec list_for_suite(GitHubSDK.Client.t(), map()) :: result
  def list_for_suite(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :list_for_suite},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec list_suites_for_ref(GitHubSDK.Client.t()) :: result
  @spec list_suites_for_ref(GitHubSDK.Client.t(), map()) :: result
  def list_suites_for_ref(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :list_suites_for_ref},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :get,
  ...
  @spec rerequest_run(GitHubSDK.Client.t()) :: result
  @spec rerequest_run(GitHubSDK.Client.t(), map()) :: result
  def rerequest_run(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :rerequest_run},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec rerequest_suite(GitHubSDK.Client.t()) :: result
  @spec rerequest_suite(GitHubSDK.Client.t(), map()) :: result
  def rerequest_suite(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :none,
      call: {GitHubSDK.Checks, :rerequest_suite},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :post,
  ...
  @spec set_suites_preferences(GitHubSDK.Client.t()) :: result
  @spec set_suites_preferences(GitHubSDK.Client.t(), map()) :: result
  def set_suites_preferences(client, params \\ %{}) when is_map(params) do
    GitHubSDK.GeneratedSupport.execute(client, params, %{
      auth_strategy: :default,
      body_mode: :remaining,
      call: {GitHubSDK.Checks, :set_suites_preferences},
      circuit_breaker: "core_api",
      form_data_mode: :none,
      headers: [],
      method: :patch,
